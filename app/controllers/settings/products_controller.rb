class Settings::ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:group_id, :name, :article, :packing, :measurement_id, :expiration_in_days, :storage_conditions, :box_capacity, :fat_fraction, :material_asset_id)
    end
end
